  ...
  return (
    <div className="w-full">
      ...
      <Card title="紹介履歴" scrollable maxHeight="calc(100vh - 400px)">
        {loading ? (
          <div className="py-8 text-center text-black">読み込み中...</div>
        ) : histories.length === 0 ? (
          <div className="py-8 text-center text-black">履歴がありません</div>
        ) : (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm">
                          {ru.refereeActivity ? (
                            <div className="text-xs">
                              <div>
                                ガチャ: {ru.refereeActivity.gachaCount}回
                              </div>
                              <div>
                                消費額: {ru.refereeActivity.totalSpent}円
                              </div>
                              {ru.refereeActivity.lastActiveAt && (
                                <div className="text-gray-400">
                                  最終:{" "}
                                  {formatDate(ru.refereeActivity.lastActiveAt)}
                                </div>
                              )}
                            </div>
                          ) : (
                        ...
                        <td className="px-4 py-3 text-sm text-black">
                          ...
                          {ru.additionalRewardGranted &&
                            ru.additionalRewardGrantedAt && (
                              <div className="text-xs text-green-600">
                                追加報酬:{" "}
                                {formatDate(ru.additionalRewardGrantedAt)}
                              </div>
                            )}
                        </td>
                        <td className="px-4 py-3 text-sm">
