           ...
           if (paymentIntentClientSecret) {
             ...
             if (paymentIntent.status === 'succeeded') {
              ...
              if (!pointsUpdated) {
                ...
                alert('決済は成功しましたが、ポイントの反映に時間がかかっています。\nしばらくしてからページを更新してください。');
                setSelectedPlan(null);
              }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="mx-auto max-w-md">
        <h1 className="mb-6 text-center text-2xl font-bold text-gray-800">ポイント購入</h1>
        ...
        {!selectedPlan ? (
          <div className="mb-6">
            <h2 className="mb-4 text-lg font-semibold text-gray-800">プランを選択</h2>
            <div className="grid grid-cols-2 gap-3">
              {POINT_PLANS.map((plan) => (
                ...
                >
                  <div className="mb-2 text-lg font-bold text-gray-800">{plan.label}</div>
