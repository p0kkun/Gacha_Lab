...
-- CreateEnum
CREATE TYPE "AdminActionType" AS ENUM ('LOGIN', 'LOGOUT', 'CREATE_ADMIN', 'UPDATE_ADMIN', 'DELETE_ADMIN', 'RESET_PASSWORD', 'CREATE_ROLE', 'UPDATE_ROLE', 'DELETE_ROLE', 'CREATE_EXCLUSION_LINK', 'UPDATE_EXCLUSION_LINK', 'DELETE_EXCLUSION_LINK', 'ACCESS', 'POINT_GRANT', 'POINT_PLAN_CREATE', 'POINT_PLAN_UPDATE', 'POINT_PLAN_DELETE', 'POINT_PLAN_TOGGLE', 'ITEM_GRANT', 'ITEM_CREATE', 'ITEM_UPDATE', 'ITEM_DELETE', 'GACHA_PROBABILITY_UPDATE', 'GACHA_TYPE_CREATE', 'GACHA_TYPE_UPDATE', 'GACHA_TYPE_DELETE', 'GACHA_TYPE_ICON_UPDATE', 'GACHA_SIMULATE', 'GACHA_TIER_WEIGHT_UPDATE', 'GACHA_PRIZE_ASSIGNMENT_CREATE', 'GACHA_PRIZE_ASSIGNMENT_UPDATE', 'GACHA_PRIZE_ASSIGNMENT_DELETE', 'FREE_GACHA_SETTINGS_UPDATE', 'VIDEO_UPLOAD', 'VIDEO_UPDATE', 'VIDEO_DELETE', 'VIDEO_DEFAULT_SETTINGS_UPDATE', 'TAG_CREATE', 'TAG_UPDATE', 'TAG_DELETE', 'TAG_ASSIGN', 'TAG_BULK_ASSIGN', 'USER_UPDATE', 'USER_TAG_REMOVE', 'MESSAGE_SEND', 'RESULT_MESSAGE_TEMPLATE_CREATE', 'RESULT_MESSAGE_TEMPLATE_UPDATE', 'RESULT_MESSAGE_TEMPLATE_DELETE', 'PRIZE_TIER_CREATE', 'PRIZE_TIER_UPDATE', 'PRIZE_TIER_DELETE', 'OTHER');
