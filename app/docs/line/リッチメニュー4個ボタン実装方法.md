...
- **URI**: 
  ...
  - **審査用**: `https://miniapp.line.me/2008642685-xyZrjKKN?action=referral`
  - **本番用**: `https://miniapp.line.me/2008642686-qmd6bXXk?action=referral`
- **ラベル**: 友だち紹介

**注意：**

- 環境ごとに異なるLIFF URLを使用
- 開発用: `2008642684-d8jPmggE`
- 審査用: `2008642685-xyZrjKKN`
- 本番用: `2008642686-qmd6bXXk`
