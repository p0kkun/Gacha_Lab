...
詳細は [LIFF_URL設定](./LIFF_URL設定.md) を参照してください。
...
- ガチャ結果の通知を扱う場合は、[ガチャ結果LINE通知機能](./ガチャ結果LINE通知機能.md) を参照してください。

---

## 参考資料

- （参考リンクは整理中です。必要であれば本ドキュメント内に追記します）
- [LIFF_URL 設定](./LIFF_URL設定.md)
